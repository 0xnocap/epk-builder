              ...
              <div className="flex justify-center gap-4 flex-nowrap">
                {data.spotifyMonthlyListeners && (
                  <a href={data.musicLinks?.spotify || "#"} target="_blank" rel="noopener noreferrer"
                    className="p-5 rounded-2xl text-center transition-all hover:scale-[1.02] w-[180px] shrink-0"
                ...
                {(data.genres?.length > 0 || genre) && (
                  <div className="p-5 rounded-2xl flex flex-col items-center justify-center gap-2 w-[180px] shrink-0"
