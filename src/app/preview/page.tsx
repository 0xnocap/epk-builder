              ...
              <div className="flex flex-wrap justify-center gap-4">
                {data.spotifyMonthlyListeners && (
                  <a href={data.musicLinks?.spotify || "#"} target="_blank" rel="noopener noreferrer"
                    className="p-5 rounded-2xl text-center transition-all hover:scale-[1.02] w-[200px]"
                ...
                {(data.genres?.length > 0 || genre) && (
                  <div className="p-5 rounded-2xl flex flex-col items-center justify-center gap-2 w-[200px]"
